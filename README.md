...
- IDEs & Webapps for Python include JetbrainsPycharm & Jupyter Notebooks. I've also set up a mssql server '19 on in a docker container to run Azure Data Studio as my IDE for SQL testing and development. 
